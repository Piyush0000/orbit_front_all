            ...
            <div className="container mx-auto flex h-16 items-center justify-between px-4">
                ...
                <div className="flex items-center gap-2">
                    <Link href="/" className="flex items-center space-x-2">
                        <span className="text-2xl font-serif tracking-tight text-primary italic">Provision & Co.</span>
                    </Link>
                </div>
                ...
                <div className="flex items-center gap-2 md:gap-4">
                    <div className="hidden lg:flex items-center gap-3">
                        <Link href="/login">
                            <Button variant="ghost" className="text-xs font-bold uppercase tracking-widest hover:bg-primary/5 px-6 rounded-full">
                                Log In
                            </Button>
                        </Link>
                        <Link href="/signup">
                            <Button className="text-xs font-bold uppercase tracking-widest px-8 rounded-full bg-primary text-primary-foreground shadow-lg hover:scale-105 transition-transform">
                                Sign Up
                            </Button>
                        </Link>
                    </div>
                    ...
                    <Sheet open={isOpen} onOpenChange={setIsOpen}>
                        ...
                        <SheetContent side="left" className="w-[300px] sm:w-[350px] p-6">
                            <SheetHeader className="text-left mb-8">
                                <SheetTitle className="text-2xl font-serif text-primary italic">
                                    Provision & Co.
                                </SheetTitle>
                            </SheetHeader>
